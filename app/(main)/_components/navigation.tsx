...
export const Navigation = () => {
    ...
    const [isCollapsed, setIsCollapsed] = useState(isMobile); //Caso o dispositivo seja mobile o collapse ocorre automáticamente
    ...
    const handleCreate = () => {
        ...
        toast.promise(promise, {
            ...
            success:"Uma nova nota foi criada!",
    ...
    return(
        ...
        <aside 
        ref={sidebarRef}
        className={cn("group/sidebar h-full bg-secondary overflow-y-auto relative flex w-60 flex-col z-[999]",isResetting && "transition-all ease-=in-out duration-300", isMobile && "w-0")}>
            <div
            onClick={collapse}
            role="button"
